...
{   
    ...
    if ($global_password == $entered_password) echo "<span class='h1 text-light'>DONE!</span>";
    else
    {
        echo '
...
<body>
    <div class="container-fluid min-vh-100">
        <img src="png/logo.png" class="img-fluid mx-auto d-block logo pb-5 pt-5" alt="logo">
        <form action="" method="post">
            <div class="form-group d-flex flex-column justify-content-center align-items-center">
                <label class="h1 text-light" for="password">Podaj hasło:</label>
                <input id="password" name="password" class="form-control text-center w-50 mt-2 mb-3" type="password">
